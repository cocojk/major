...
void *FindMinMaxPath(void *args) {
    ...
    queue[start_idx] = (vid_t *)malloc(MAX_VERTICES*2 * sizeof(vid_t));
    int front;
    int rear;
    front = rear = 0;
    ...
    int *find_me = (int *)malloc(10 * sizeof(int));
    ...
    while (front < rear) {
        ...
        if (curr_node >= MAX_DEPTH) {
            ...
            g_have_a_nice_weekend = curr_depth;
